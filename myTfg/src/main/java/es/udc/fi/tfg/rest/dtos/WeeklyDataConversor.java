  ...
  public static String toClingoParams(WeeklyDataDto weeklyDataDto, List<Priority> costs,
    ...
    for (Priority priority : costs) {
      switch (priority.getId()) {
        ...
        case "semanalP_04" -> clingoParams.append(String.format("cost(semanalP_03_4_5,red,%d). ", priority.getCost()));
        case "semanalP_05" -> clingoParams.append(String.format("cost(semanalP_03_4_5,blue,%d). ", priority.getCost()));
        default -> clingoParams.append(String.format("cost(%s,%d). ", priority.getId(), priority.getCost()));
      }
    }
