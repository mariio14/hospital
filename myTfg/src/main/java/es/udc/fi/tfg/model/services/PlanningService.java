...
public interface PlanningService {
    ...
    Map<String, Map<Integer, List<String>>> getWeeklyPlanning(String params, int year, String month, String week) throws NoSolutionException;
    ...
    Map<String, Map<Integer, List<String>>> getWeekFromJson(int year, String month, String week) throws IOException, ClassNotFoundException;
}
